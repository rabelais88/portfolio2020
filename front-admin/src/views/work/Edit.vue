...
export default {
  ...
  methods: {
    ...
    ...mapActions('work', { modifyWork: MODIFY_WORK }),
    ...
    async onSubmit() {
      ...
      await this.modifyWork();
      Message({ message: 'Work is updated!', type: 'success', duration: 5000 });
      this.$loading.close();
      return null;
    },
    onRemoveTag(tag) {
  ...
  async beforeRouteEnter(to, from, next) {
    ...
    await store.dispatch(`work/${LOAD_WORK}`, to.params.articleId, {
      root: true,
    });
    next();
  },
